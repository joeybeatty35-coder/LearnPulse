...
(function () {
  ...
  function isExpired() {
    ...
    const days = daysBetween(new Date(start), new Date());
    return days >= TEST_DAYS;
  }
  ...
  function checkAccess() {
    const allowed = localStorage.getItem(ACCESS_KEY) === "true";
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (saveBtn) {
    saveBtn.addEventListener("click", () => {
      ...
      savePrefs(p);
      renderFeed(p);
      showToast("Saved. Your LearnPulse feed has been customized.");
